function [] = stimgen_ccv_task1_comp(i_machine,n_machines,save_path_base)
...
shape1_path                 = './element_shapes/setX/';
save_path = strcat(save_path_base,'AX_X/'); %target_composition - target_element - distractor_composition - distractor_element
